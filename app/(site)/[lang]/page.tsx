    ...
    <main className="min-h-screen md:h-screen md:max-h-screen bg-[#050505] text-zinc-300 flex flex-col justify-between selection:bg-red-950 selection:text-red-300 antialiased relative overflow-x-hidden md:overflow-hidden pb-4 md:pb-0">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-4 md:py-6 flex justify-between items-center relative z-40 border-b border-zinc-900/40">
        ...
        <div className="flex items-center gap-3 lg:gap-5 flex-shrink-0">
          ...
          <div className="flex items-center gap-3 lg:gap-5 flex-shrink-0">
            <a href="https://t.me/Emberhome" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-[#26A5E4] transition-colors duration-200" aria-label="Telegram">
            ...
            <a href="https://discord.gg/uxm8xxk4qc" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-[#5865F2] transition-colors duration-200" aria-label="Discord">
            ...
            <a href="https://boosty.to/emberhome" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-[#ff4622] transition-colors duration-200" aria-label="Boosty">
